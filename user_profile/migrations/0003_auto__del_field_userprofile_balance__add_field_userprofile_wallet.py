...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'user_profile_userprofile', 'balance')

        # Adding field 'UserProfile.wallet'
        db.add_column(u'user_profile_userprofile', 'wallet',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_bitcoin.Wallet'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.balance'
        db.add_column(u'user_profile_userprofile', 'balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=8),
                      keep_default=False)

        # Deleting field 'UserProfile.wallet'
        db.delete_column(u'user_profile_userprofile', 'wallet_id')
    ...
    models = {
        ...
        u'django_bitcoin.wallettransaction': {
            ...
            'from_wallet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sent_transactions'", 'to': u"orm['django_bitcoin.Wallet']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'user_profile.userprofile': {
            ...
            'bitcoin_address': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['django_bitcoin.BitcoinAddress']", 'unique': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone_number': ('django.db.models.fields.CharField', [], {'max_length': "'100'"}),
            'secret_code': ('django.db.models.fields.CharField', [], {'max_length': "'50'"}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
            'wallet': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['django_bitcoin.Wallet']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        }
    }
