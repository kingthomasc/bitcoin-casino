...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'user_profile_userprofile', (
            ...
            ('secret_code', self.gf('django.db.models.fields.CharField')(max_length='50')),
            ('bitcoin_address', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_bitcoin.BitcoinAddress'], unique=True)),
            ('balance', self.gf('django.db.models.fields.DecimalField')(max_digits='16', decimal_places='8')),
        ))
    ...
    models = {
        ...
        u'user_profile.userprofile': {
            ...
            'balance': ('django.db.models.fields.DecimalField', [], {'max_digits': "'16'", 'decimal_places': "'8'"}),
            'bitcoin_address': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['django_bitcoin.BitcoinAddress']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
